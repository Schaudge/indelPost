...
class Contig(object):
    ...
    """
    def __init__(self, target: Variant, pileup: list, unspl_loc_ref: UnsplicedLocalReference,
                 basequalthresh: int, mapqthresh: int, donwsample_lim=100):
        self.low_consensus_thresh = 0.7
        self.target = target
        self.pileup = pileup
